...
const MESSAGES = {
  en: {
    ...
    "lexicon.clickHint": "Drag this tile onto a word for a single synonym/antonym list (5 or 10 with Broad Choice), then mix to consume the token.",
  ...
  ru: {
    ...
    "lexicon.clickHint": "Перетащите на слово — один список (5 или 10 с Широким выбором). Смешивание тратит токен.",
