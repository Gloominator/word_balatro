...
const MESSAGES = {
  en: {
    ...
    "questWin.subtitle": "You discovered every encyclopedia word and finished the run.",
    "questWin.copy": "Encyclopedia completion reached 100%.",
  ...
  ru: {
    ...
    "questWin.subtitle": "Вы открыли все слова в энциклопедии и завершили забег.",
    "questWin.copy": "Энциклопедия заполнена на 100%.",
